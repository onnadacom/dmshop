...
if (is_uploaded_file($tmp_name) || $file_del) {
    ...
    // 데이터
    $file = sql_fetch(" select * from $shop[user_level_file_table] where upload_mode = '".addslashes($upload_mode)."' ");
    ...
    if ($file['upload_file']) {
        ...
        // 삭제
        sql_query(" delete from $shop[user_level_file_table] where upload_mode = '".addslashes($upload_mode)."' ");
...
if (is_uploaded_file($tmp_name)) {
    ...
    // 등록
    sql_query(" insert into $shop[user_level_file_table] $sql_common ");
