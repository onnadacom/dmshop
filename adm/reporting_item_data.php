...
if ($reporting_mode == 'year') {
    ...
    include_once("./reporting_item_data.{$reporting_segment}.year.php");

}

else if ($reporting_mode == 'month') {

    include_once("./reporting_item_data.{$reporting_segment}.month.php");

}

else if ($reporting_mode == 'day') {

    include_once("./reporting_item_data.{$reporting_segment}.day.php");

}

else if ($reporting_mode == 'hour') {

    include_once("./reporting_item_data.{$reporting_segment}.hour.php");

}

else if ($reporting_mode == 'week') {

    include_once("./reporting_item_data.{$reporting_segment}.week.php");
