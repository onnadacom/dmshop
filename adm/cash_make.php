...
$shop_pages = shop_paging_v0("10", $page, $total_page, "?c=".$c."&level=".$level."&sort=".$sort."&rows=".$rows."&f=".$f."&q=".$q."&page=");
...
function checkSave()
{
    ...
    var f1 = document.formUpdate;

    if (f1.cash.value == '') {

        alert("<?=$message?> 금액을 입력하여주세요.");
        f1.cash.focus();
        return false;
    ...
    var f2 = document.formList;

    f2.m.value = "all";
    f2.cash.value = f1.cash.value;
    f2.content.value = f1.content.value;

    if (!confirm("선택한 회원에게 적립금을 <?=$message?> 하시겠습니까?")) {

        return false;

    }

    f2.action = "./cash_make_update.php";
    f2.submit();
...
function listMake(user_id)
{
    ...
    if (!confirm("해당 회원에게 적립금을 <?=$message?> 하시겠습니까?")) {

        return false;

    }

    f.action = "./cash_make_update.php";
    f.submit();
...
function cashAll()
{
    ...
    if (!confirm(level+" 회원에게 적립금을 <?=$message?> 하시겠습니까?")) {
...
<tr class="title_bg2">
    ...
    <td class="bigtitle">적립금 <?=$message?></td>
</tr>
</table>
...
<tr>
    <td width="20"></td>
    <td class="tx1"><?=$message?> 금액</td>
    <td width="10"></td>
    <td><input type="text" name="cash" value="" onFocus="shopInfocus1(this); keywordOver();" onBlur="shopOutfocus1(this);" class="input" style="width:42px;" /></td>
    <td width="5"></td>
    <td class="tx2">원</td>
    <td width="20"></td>
    <td class="tx1"><?=$message?>명</td>
    <td width="10"></td>
    <td><input type="text" name="content" value="" onFocus="shopInfocus1(this); keywordOver();" onBlur="shopOutfocus1(this);" class="input" style="width:200px;" /></td>
</tr>
</table>
...
<tr>
    <td width="20"></td>
    <td class="help1">지급하실 금액(적립금)을 입력하신 후, 지급명을 입력하세요. (예 : 우수회원 특별 적립금)</td>
</tr>
</table>
    </td>
</tr>
...
<form method="get" name="formSearch" action="cash_make.php" onSubmit="return listSearch('');" autocomplete="off">
<input type="hidden" name="c" value="<?=$c?>" />
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
$("#level").val("<?=$level?>");
    ...
    <td width="10"></td>
    <td class="help1"><?=$message?>대상(회원)을 선택하세요.</td>
</tr>
</table>
    </td>
...
<table border="0" cellspacing="0" cellpadding="0">
<tr>
    <td><a href="#" onclick="cashAll(); return false;"><img src="<?=$shop['image_path']?>/adm/cash_all_<?=$c?>.gif" border="0"></a></td>
    <td width="20"></td>
</tr>
</table>
    </td>
...
<select id="f" name="f" class="select">
    ...
    <td width="4"></td>
    <td><a href="./cash_make.php?c=<?=$c?>"><img src="<?=$shop['image_path']?>/adm/reset.gif" border="0"></a></td>
    <td width="20"></td>
</tr>
</table>
    </td>
...
<tr height="46">
    ...
    <td class="bc1"></td>
    <td align="center" class="user_cash"><?=number_format($list['user_cash']);?></td>
    <td class="bc1"></td>
    <td>
<table border="0" cellspacing="0" cellpadding="0">
<tr>
...
<tr>
    ...
    <td class="bc1"></td>
    <td align="right"><a href="#" onclick="listMake('<?=text($list['user_id'])?>'); return false;"><img src="<?=$shop['image_path']?>/adm/list_make.gif" border="0"></a></td>
    <td></td>
</tr>
<tr><td colspan="<?=$colspan?>" height="1" class="bc1"></td></tr>
<? } ?>
...
<tr>
    <td class="msg2">회원목록의 체크박스상 선택된 회원에게, 선택하신 적립금을 <?=$message?> 합니다.</td>
</tr>
</table>
</form>
