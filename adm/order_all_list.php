...
// 검색조건
$sql_search = " where order_payment in (1,2) and order_number = '0' ";
...
<form method="get" name="formSearch" action="order_all_list.php" onSubmit="return listSearch('');" autocomplete="off">
...
<select id="f" name="f" class="select">
    ...
    <td width="4"></td>
    <td><a href="./order_all_list.php"><img src="<?=$shop['image_path']?>/adm/reset.gif" border="0"></a></td>
    <td width="20"></td>
</tr>
</table>
    </td>
