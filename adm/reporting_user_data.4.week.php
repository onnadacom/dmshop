...
for ($i=0; $i<count($list); $i++) {
    ...
    // 전체
    $total = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' ");

    $area1 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '서울%' ");
    $area2 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '강원%' ");
    $area3 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '대전%' ");
    $area4 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '충남%' ");
    $area5 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '충북%' ");
    $area6 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '경기%' ");
    $area7 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '인천%' ");
    $area8 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '광주%' ");
    $area9 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '전남%' ");
    $area10 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '전북%' ");
    $area11 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '부산%' ");
    $area12 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '경남%' ");
    $area13 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '경북%' ");
    $area14 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '대구%' ");
    $area15 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '울산%' ");
    $area16 = sql_fetch(" select count(*) as report_count from $shop[user_table] where dayofweek(datetime) = '".$list[$i]['dayofweek']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_addr1 LIKE '제주%' ");
