...
<div id="display<?=$display_id?>_2" <? if ($dmshop_design["display".$display_id."_type"] == '2') { echo "style='display:inline;'"; } else { echo "style='display:none;'"; } ?>>
<table border="0" cellspacing="0" cellpadding="0">
<tr>
    <td width="471" valign="top" class="display_line_bg2" style="border-bottom:1px solid #c2c2c2;">
...
<div style="border-top:1px solid #c2c2c2; width:469px; margin:0 auto;">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
