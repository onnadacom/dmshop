...
<?
$result = sql_query(" select * from $shop[order_table] where order_payment != '0' and order_number = '0' and order_type = '400' order by order_datetime desc limit 0, 5 ");
...
<tr height="44">
    ...
    <td width="1"></td>
    <td width="90" align="center"><a href="#" onclick="orderManage('exchange', '<?=$row['order_code']?>'); return false;"><img src="<?=$shop['image_path']?>/adm/list_option.gif" border="0"></a></td>
    <td width="10"></td>
</tr>
