...
<form method="get" name="formSearch" action="coupon_make_list.php" onSubmit="return listSearch('');" autocomplete="off">
...
<tr>
    <td width="20"></td>
    <td class="listname">지급내역</span></td>
    <td width="10"></td>
...
<select id="sort" name="sort" class="select" onchange="listSearch('sort');">
    <option value="datetime desc">지급일시 내림차순</option>
    <option value="datetime asc">지급일시 오름차순</option>
...
<select id="f" name="f" class="select">
    ...
    <td width="4"></td>
    <td><a href="./coupon_make_list.php"><img src="<?=$shop['image_path']?>/adm/reset.gif" border="0"></a></td>
    <td width="20"></td>
</tr>
</table>
    </td>
...
?>
    ...
    <td class="bc1"></td>
    <td align="center" class="tx2"><?=shop_coupon_mode($list['coupon_mode'])?></td>
    <td class="bc1"></td>
