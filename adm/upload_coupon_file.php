...
if (is_uploaded_file($tmp_name) || $file_del) {
    ...
    // 데이터
    $file = sql_fetch(" select * from $shop[coupon_file_table] where coupon_id = '".addslashes($coupon_id)."' and upload_mode = '".addslashes($upload_mode)."' ");
    ...
    if ($file['upload_file']) {
        ...
        // 삭제
        sql_query(" delete from $shop[coupon_file_table] where coupon_id = '".addslashes($coupon_id)."' and upload_mode = '".addslashes($upload_mode)."' ");
...
if (is_uploaded_file($tmp_name)) {
    ...
    $sql_common = "";
    $sql_common .= " set coupon_id = '".addslashes($coupon_id)."' ";
    ...
    // 등록
    sql_query(" insert into $shop[coupon_file_table] $sql_common ");
