...
function reportingExcel()
{
    ...
    f.action = "./reporting_visit_data.php";
    f.submit();
...
function reportingStart()
{
    ...
    $.post("./reporting_visit_data.php", {"date1" : f.date1.value , "date2" : f.date2.value, "reporting_mode" : f.reporting_mode.value, "reporting_segment" : f.reporting_segment.value}, function(data) {
