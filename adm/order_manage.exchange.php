...
// help 데이터
$dmshop_help = shop_help_new($order_code, "400");
?>
<!-- 교환접수 start //-->
...
<tr>
    ...
    <td width="5"></td>
    <td><img src="<?=$shop['image_path']?>/adm/manage_t9.gif"></td>
</tr>
</table>
...
<form method="post" name="formExchange" autocomplete="off">
...
<tr height="30">
    <td bgcolor="#f7f7f7" class="popup_subject">교환 접수일시</td>
    <td bgcolor="#e4e4e4"></td>
    <td></td>
    <td><span class="datetime1"><?=date("Y-m-d", strtotime($dmshop_order['order_exchange_datetime']));?></span><span class="datetime2"> <?=date("H시 : i분", strtotime($dmshop_order['order_exchange_datetime']));?></span></td>
</tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
    <td class="tx2"><?=text($dmshop_help['content'], 0);?></td>
</tr>
</table>
...
<tr><td colspan="4" height="1" bgcolor="#bbbbbb"></td>
<tr height="30">
    <td bgcolor="#f7f7f7" class="popup_subject">교환 상태</td>
    <td bgcolor="#e4e4e4"></td>
    <td></td>
    <td class="tx2"><?=shop_order_type($dmshop_order['order_type']);?></td>
</tr>
<?
if ($dmshop_order['order_exchange_ok_datetime']) {
?>
<tr><td colspan="4" height="1" bgcolor="#bbbbbb"></td>
<tr height="30">
    <td bgcolor="#f7f7f7" class="popup_subject">교환 승인일시</td>
    <td bgcolor="#e4e4e4"></td>
    <td></td>
    <td><span class="datetime1"><?=date("Y-m-d", strtotime($dmshop_order['order_exchange_ok_datetime']));?></span><span class="datetime2"> <?=date("H시 : i분", strtotime($dmshop_order['order_exchange_ok_datetime']));?></span></td>
</tr>
<? } ?>
</table>
...
<? if ($dmshop_order['order_exchange'] == '1') { ?>
<table border="0" cellspacing="0" cellpadding="0" class="auto">
<tr>
    <td><a href="#" onclick="submitExchange('exchange_ok'); return false;"><img src="<?=$shop['image_path']?>/adm/manage_exchange_ok.gif" border="0"></a></td>
    <td width="1"></td>
    <td><a href="#" onclick="submitExchange('exchange_cancel'); return false;"><img src="<?=$shop['image_path']?>/adm/manage_exchange_cancel.gif" border="0"></a></td>
</tr>
</table>
<? } ?>
</form>
...
<tr>
    <td>
<p class="help4">- 주문자가 상품수령 후, 환경설정의 교환/환불 신청기간 내에 상품교환을 요청한 상태 입니다.</p>
<p class="help4">- 교환접수 내역을 확인하고, 교환승인 전 상담을 통해 아래의 사항을 꼭 체크하시기 바랍니다.</p>
<p class="help4">&nbsp;&nbsp;(1) 소비자 or 판매자의 과실, (2) 제품사용 여부, (3) 왕복 택배비 부담, (4) 반품주소 안내</p>
<p class="help4">- 교환승인 시, 새로 발송되는 상품의 송장번호는 답변 또는 문자, 전화를 통해 안내 하시기 바랍니다.</p>
<p class="help4">- 교환거절 시, 본 주문건은 전산상 “배송완료” 처리 됩니다.</p>
<p class="help4">- 부득이 환불처리를 진행하고자 할 경우, 상단의 "직권주문 취소"를 클릭하고,<br />
&nbsp;&nbsp;결제수단이 전자결제일 경우 PG사의 홈페이지를 방문하여 해당 결제건의 승인취소를 요청 하시고, 
    <br />
