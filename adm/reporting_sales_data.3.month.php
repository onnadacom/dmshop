...
for ($i=0; $i<count($list); $i++) {
    ...
    echo $comma."['".$list[$i]['month']."',".(int)($list[$i]['total_order_count']).",".(int)($list[$i]['total_item_money']).",".(int)($list[$i]['total_option_money']).",".(int)($list[$i]['total_order_total_item_money'])."]";
