...
for ($i=0; $i<count($list); $i++) {
    ...
    // 10대 미만
    $age0 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) > '".(int)(date("Y", $shop['server_time']) - 9)."' ");

    // 10대
    $age1 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) >= '".(int)(date("Y", $shop['server_time']) - 18)."' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 9)."' ");

    // 20대
    $age2 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) >= '".(int)(date("Y", $shop['server_time']) - 28)."' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 19)."' ");

    // 30대
    $age3 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) >= '".(int)(date("Y", $shop['server_time']) - 38)."' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 29)."' ");

    // 40대
    $age4 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) >= '".(int)(date("Y", $shop['server_time']) - 48)."' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 39)."' ");

    // 50대
    $age5 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) >= '".(int)(date("Y", $shop['server_time']) - 58)."' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 49)."' ");

    // 60대
    $age6 = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth != '' and substring(user_birth,1,4) <= '".(int)(date("Y", $shop['server_time']) - 59)."' ");

    // 없다
    $etc = sql_fetch(" select count(*) as report_count from $shop[user_table] where substring(datetime,1,4) = '".$list[$i]['year']."' and substring(datetime,1,10) >= '".$date1."' and substring(datetime,1,10) <= '".$date2."' and user_leave_datetime = '0000-00-00 00:00:00' and user_birth = '' ");
