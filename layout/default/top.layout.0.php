...
<div class="layer0">
    ...
    <div class="layer1"><? $file = shop_design_file("top_logo"); if ($file['upload_file']) { echo "<a href='".$shop['url']."'>".shop_file_view($shop['path']."/data/design/".shop_data_path("u", $file['datetime'])."/".$file['upload_file'], $file['upload_width'], $file['upload_height'])."</a>"; } ?></div>
    <div class="layer2"><?=shop_searchbox_skin($dmshop_top['top_searchbox_skin']);?></div>
