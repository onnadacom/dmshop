...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
    <td><table border="0" cellspacing="0" cellpadding="0"><tr><td><? if ($dmshop_top['top_banner1_group']) { echo shop_banner_skin("layout_top_banner1", $dmshop_top['top_banner1_skin'], $dmshop_top['top_banner1_group'], "", "1", "1", $dmshop_top['top_banner1_rolling_limit'], $dmshop_top['top_banner1_rolling_time'], $dmshop_top['top_banner1_sort']); /* 레이어ID, 스킨명, 배너그룹ID, 배너ID, 가로갯수, 새로갯수, 롤링횟수, 롤링시간, 정렬방식 */ } else { echo "&nbsp;"; } ?></td></tr></table></td>
    <td align="center"><? $file = shop_design_file("top_logo"); if ($file['upload_file']) { echo "<a href='".$shop['url']."'>".shop_file_view($shop['path']."/data/design/".shop_data_path("u", $file['datetime'])."/".$file['upload_file'], $file['upload_width'], $file['upload_height'])."</a>"; } ?></td>
    <td align="right"><table border="0" cellspacing="0" cellpadding="0"><tr><td><? if ($dmshop_top['top_banner2_group']) { echo shop_banner_skin("layout_top_banner2", $dmshop_top['top_banner2_skin'], $dmshop_top['top_banner2_group'], "", "1", "1", $dmshop_top['top_banner2_rolling_limit'], $dmshop_top['top_banner2_rolling_time'], $dmshop_top['top_banner2_sort']); /* 레이어ID, 스킨명, 배너그룹ID, 배너ID, 가로갯수, 새로갯수, 롤링횟수, 롤링시간, 정렬방식 */ } else { echo "&nbsp;"; } ?></td></tr></table></td>
</tr>
</table>
