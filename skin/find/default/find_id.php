...
function findSubmit()
{
    ...
    $.post("./find_id_update.php", {"user_name" : f.user_name.value, "user_email" : f.user_email.value}, function(data) {
...
echo "<td><a href='".$shop['path']."/find_id.php' class='off'>아이디 찾기</a></td>";
?>
</tr>
</table>
    </td>
...
<tr height="55">
    <td><img src="<?=$dmshop_find_path?>/img/message1.gif"></td>
</tr>
</table>
...
<script type="text/javascript">
document.getElementById("move_list").value = "find_id.php";
</script>
    </td>
    <td width="10"></td>
</tr>
...
<tr>
    ...
    <td width="10"></td>
    <td><img src="<?=$dmshop_find_path?>/img/title_id.gif"></td>
</tr>
</table>
...
<tr height="25">
    <td width="60"></td>
    <td align="right"><img src="<?=$dmshop_find_path?>/img/name.gif" id="find_name"></td>
    <td width="10"></td>
    <td><input type="text" id="user_name" name="user_name" value="" onfocus="findFocusIn(this);" onblur="findFocusOut(this);" class="input" /></td>
    <td width="60"></td>
</tr>
...
<tr height="25">
    ...
    <td width="10"></td>
    <td><input type="text" id="user_email" name="user_email" value="" onfocus="findFocusIn(this);" onblur="findFocusOut(this);" class="input" /></td>
    <td width="60"></td>
</tr>
</table>
