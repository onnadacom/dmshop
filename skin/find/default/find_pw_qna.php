...
.find_box .find_id_wait div {border-top:1px solid #ffffff; border-bottom:1px solid #ffffff; background-color:#fbfbfb; height:40px; text-align:center;}
.find_box .find_id_wait div {font-weight:bold; line-height:40px; font-size:12px; color:#787878; font-family:gulim,굴림;}
</style>
...
function findSubmit()
{
    ...
    $.post("./find_pw_qna_update.php", {"form_check" : f.form_check.value , "user_id" : f.user_id.value , "user_pw_a" : f.user_pw_a.value}, function(data) {
...
<div id="find_id_message"><div class='find_id_wait'><div>회원가입 시, 입력하신 질문의 답변을 입력하세요.</div></div></div>
...
<tr height="25">
    <td width="60"></td>
    <td align="right"><img src="<?=$dmshop_find_path?>/img/q.gif"></td>
    <td width="10"></td>
    <td class="user_pw_q"><?=filter1($user['user_pw_q']);?></td>
    <td width="60"></td>
</tr>
<tr><td colspan="3" height="5"></td></tr>
<tr height="25">
    <td width="60"></td>
    <td align="right"><img src="<?=$dmshop_find_path?>/img/a.gif"></td>
    <td width="10"></td>
    <td><input type="text" name="user_pw_a" onfocus="findFocusIn(this);" onblur="findFocusOut(this);" class="input" /></td>
    <td width="60"></td>
</tr>
</table>
