...
for ($i=$rolling_start[$n]; $i<=$rolling_end[$n]; $i++) {
    ...
    echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td><span style='line-height:14px; font-size:11px; color:#65bbe7; font-family:dotum,돋움;'><b>".number_format($list[$i]['item_money'])."</b>원</span></td></tr></table>";
    echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td height='4'></td></tr></table>";
