...
if ($display['titletype'] == '1') {
    ...
    if ($display['title']) {
        ...
        echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td style='font-weight:bold; line-height:18px; font-size:16px; color:#037d93; font-family:arial,dotum,돋움;'>".stripslashes($display['title'])."</td></tr></table>";
