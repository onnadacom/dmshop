...
for ($i=$rolling_start[$n]; $i<=$rolling_end[$n]; $i++) {
    ...
    if ($k && $k%$mod == '0') {
        ...
        echo "</tr>\n";
        echo "<tr height='8'><td colspan='".(int)(($mod * 2) - 1)."'></td></tr>\n";
        echo "<tr>\n";
    ...
    echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td height='3'></td></tr></table>";
    echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td><a href='".$item_link."' style='line-height:13px; font-size:11px; color:#676d76; font-family:dotum,돋움;'>".filter1($list[$i]['item_title'], 0, $title_len)."</a></td></tr></table>";
