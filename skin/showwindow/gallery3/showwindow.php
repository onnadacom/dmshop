...
for ($i=$rolling_start[$n]; $i<=$rolling_end[$n]; $i++) {
    ...
    if ($thumb) {
        ...
        $img = "<img src='".$thumb."'  border='0' style='border:1px solid #d9d9d9;'>";
    ...
    if ($k && $k%$mod == '0') {
        ...
        echo "</tr>\n";
        echo "<tr height='18'><td colspan='".(int)(($mod * 2) - 1)."'></td></tr>\n";
        echo "<tr>\n";

    }

    echo "<td width='".$width."' valign='top'>";
    echo "<table width='".$thumb_width."' border='0' cellspacing='0' cellpadding='0' style='table-layout:fixed;' class='auto'><tr><td>";
    ...
    echo "<table border='0' cellspacing='0' cellpadding='0' class='auto'><tr><td><a href='".$item_link."' style='font-weight:bold; line-height:16px; font-size:12px; color:#555555; font-family:dotum,돋움;'>".filter1($list[$i]['item_title'], 0, $title_len)."</a></td></tr></table>";
    echo "<table border='0' cellspacing='0' cellpadding='0'><tr><td height='4'></td></tr></table>";
    echo "<table border='0' cellspacing='0' cellpadding='0' class='auto'><tr><td>".shop_icon_view($list[$i]['item_icon'])."</td><td width='10'></td><td><span style='font-weight:bold; line-height:16px; font-size:14px; color:#bd0000; font-family:dotum,돋움;'><b>".number_format($list[$i]['item_money'])."</b>원</span></td></tr></table>";
