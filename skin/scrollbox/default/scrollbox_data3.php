...
$total_count = sql_fetch(" select count(*) as total_count from $shop[cart_table] $sql_search ");
...
$result = sql_query(" select * from $shop[cart_table] $sql_search order by datetime desc limit $limit, $rows ");
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr height="12">
    <td width="11"><a href="#" onclick="scrollboxDataLoad('3', '<?=$prev?>', 'no'); return false;"><img src="<?=$dmshop_scrollbox_path?>/img/btn_prev.gif" border="0"></a></td>
    <td class="page"><b><?=$page?></b>/<?=$max_page?></td>
    <td width="11"><a href="#" onclick="scrollboxDataLoad('3', '<?=$next?>', 'no'); return false;"><img src="<?=$dmshop_scrollbox_path?>/img/btn_next.gif" border="0"></a></td>
</tr>
</table>
...
$(document).ready(function() {
    ...
    var data = "<div class='not'>장바구니에<br>담긴 상품이<br>없습니다.</div>";

    $("#scrollbox_data3").html(data);
