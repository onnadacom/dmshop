...
<form method="post" name="formQna" action="qna_password_update.php" onsubmit="return qnaSave();">
...
<tr height="30">
    ...
    <td width="10"></td>
    <td><input type="password" id="qna_password" name="qna_password" class="input" value="" /></td>
</tr>
</table>
</div>
</div>
...
if ($m == 'u') {
    ...
    echo "상품문의 수정을 위해, 초기 입력한 비밀번호를 입력 하세요.";

}

else if ($m == 'd') {

    echo "상품문의 삭제를 위해, 초기 입력한 비밀번호를 입력 하세요.";

} else {

    echo "상품문의 열람을 위해, 초기 입력한 비밀번호를 입력 하세요.";
...
<table border="0" cellspacing="0" cellpadding="0" class="auto">
<tr>
    <td><img src="<?=$dmshop_item_path?>/img/secret2.gif" class="up2"></td>
    <td width="5"></td>
    <td class="help2">열람버튼 클릭 후, 상품문의 목록을 통해 확인 하세요.</td>
</tr>
</table>
<? } ?>
</form>
...
<script type="text/javascript">
document.getElementById("qna_password").focus();
</script>