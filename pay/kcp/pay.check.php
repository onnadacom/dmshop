...
for ($i=0; $i<count($chk_id); $i++) {
    ...
    if (!$row['id']) {
        ...
        alert("결제하는 도중 장바구니의 상품이 삭제되었습니다.\\n\\n처음부터 다시 이용하시기 바랍니다.");
    ...
    // 판매중지
        ...
        alert("{$dmshop_item['item_title']} 상품은 판매가 중지되었습니다.\\n\\n처음부터 다시 이용하시기 바랍니다.");
    ...
    // 품절
        ...
        alert("{$dmshop_item['item_title']} 상품은 품절되었습니다.\\n\\n처음부터 다시 이용하시기 바랍니다.");
    ...
    if ($shop_user_login) {
        ...
        if ($dmshop_user['user_id'] != $row['user_id']) {
            ...
            alert("{$dmshop_item['item_title']} 상품은 내 장바구니에 담긴 상품이 아닙니다.\\n\\n처음부터 다시 이용하시기 바랍니다.");
    ...
    if ($row['order_option']) {
        ...
        if ($dmshop_item_option['option_limit'] < $row['order_limit']) {
            ...
            alert("{$dmshop_item['item_title']} 상품의 {$dmshop_item_option['option_name']} 재고수량은 {$dmshop_item_option['option_limit']}개 입니다.\\n\\n수량을 확인하신 후 다시 주문하시기 바랍니다.");
    ...
    // 일반
        ...
        if ($dmshop_item['item_limit'] < $row['order_limit']) {
            ...
            alert("{$dmshop_item['item_title']} 상품의 재고수량은 {$dmshop_item_option['option_limit']}개 입니다.\\n\\n수량을 확인하신 후 다시 주문하시기 바랍니다.");
...
if ($_POST['order_pay_money'] < '0') {
    ...
    alert("결제 금액이 마이너스 입니다. 처음부터 다시 이용하여 주시기 바랍니다.");
...
if ($_POST['order_cash'] && $dmshop_user['user_cash'] < $_POST['order_cash']) {
    ...
    alert("결제에 사용될 적립금이 부족합니다. 처음부터 다시 이용하여 주시기 바랍니다.");
