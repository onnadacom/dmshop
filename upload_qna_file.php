...
if (is_uploaded_file($tmp_name) || $file_del) {
    ...
    // 파일
    $file = shop_qna_file($upload_mode);
    ...
    if ($file['upload_file']) {
        ...
        // 삭제
        sql_query(" delete from $shop[qna_file_table] where upload_mode = '$upload_mode' ");
...
*/
    ...
    // 등록
    sql_query(" insert into $shop[qna_file_table] $sql_common ");
